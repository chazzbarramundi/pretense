...
local savefile = 'pretense_caucasus_2.0.json'
if lfs then 
	...
	upgrades = {
		basic = {
			tent = Preset:new({
				...
				value=1,
				type = 'upgrade',
				templates = {"tent", "tent_1", "tent_2", "tent_3", "tent_4", "tent_5", "hesco_tower1", "hesco_tower2", "hesco_tower3", "tower1"}
			}),
			comPost = Preset:new({
				display = 'Barracks',
				cost = 1500,
				value=1,
				type = 'upgrade',
				templates = {"barracks", "building7", "building8"}
			})
		},
		attack = {
			ammoCache = Preset:new({
				...
				value=2,
				type = 'upgrade',
				templates = {"ammo-cache", "hesco_gen"}
			}),
			ammoDepot = Preset:new({
				...
				value=2,
				type = 'upgrade',
				templates = {"ammo-depot", "building1"}
			})
		},
		supply = {
			...
			factory = Preset:new({
				...
				value=3,
				income = 20,
				templates = {"factory-1", "factory-2", "building2", "building3", "building4"}
			}),
			...
			hq = Preset:new({
				...
				value=4,
				income = 50,
				templates = { "tv-tower", "hq-building" }
			})
		},
		airdef = {
...
zones.kutaisi.isPlaneSpawn = true
...
zones.beslan.isPlaneSpawn = true
...
zones.tyrnyauz.airbaseName = 'Tyrnyauz'
...
zones.mozdok.isPlaneSpawn = true
...
zones.gudauta.isPlaneSpawn = true
...
zones.november.airbaseName = 'November'
...
zones.sierra.airbaseName = 'Sierra'
...
zones.farm:defineUpgrades({
    [1] = 
    {
        ...
        presets.upgrades.supply.farm:extend({
...
zones.distillery:defineUpgrades({
    [1] = 
    {
        ...
        presets.upgrades.supply.factory:extend({
            ...
            products = {
                presets.missions.supply.convoy:extend({ name='distillery-supply-red-2', capacity=2000}),
    ...
    [2] = 
    {
        ...
        presets.upgrades.supply.factory:extend({
            ...
            products = {
                presets.missions.supply.convoy:extend({ name='distillery-supply-blue-2', capacity=2000}),
...
zones.cherkessk.airbaseName = 'Cherkessk'
...
zones.factory:defineUpgrades({
    [1] = 
    {
        ...
        presets.upgrades.supply.factory:extend({
            ...
            products = {
                presets.missions.supply.convoy:extend({ name='factory-supply-red-2'}),
    ...
    [2] = 
    {
        ...
        presets.upgrades.supply.factory:extend({
            ...
            products = {
                presets.missions.supply.convoy:extend({ name='factory-supply-blue-2'}),
...
zones.sukhumi.isPlaneSpawn = true
...
mt = MissionTracker:new({x=-126280,z=79019})
...
TransmissionManager.baseStation = {x = -280761, z=646675, y = 10000 } 
...
tarawamap = cmap2:getNavMap()
for i,v in ipairs(cmap1:getNavMap()) do
	table.insert(tarawamap, v)
end

tarawa = CarrierCommand:new("LHA-1", 1000, tarawamap, {
	tacan = {channel = 44, callsign="TRW"},
	radio = 139500000
}, 20000)

tarawa:addSupportFlight("Valkyrie Flight", 2000, CarrierCommand.supportTypes.strike, {altitude = 15000})
tarawa:addSupportFlight("Raven Flight", 2000, CarrierCommand.supportTypes.sead, {altitude = 25000})
tarawa:addSupportFlight("Voodoo Flight", 3000, CarrierCommand.supportTypes.transport, {altitude = 500})
tarawa:addSupportFlight("Nova Flight", 3000, CarrierCommand.supportTypes.transport, {altitude = 500})
...
stennis:addSupportFlight("Viper Flight", 2000, CarrierCommand.supportTypes.sead, {altitude = 25000})
stennis:addSupportFlight("Eagle Flight", 1000, CarrierCommand.supportTypes.recon, {altitude = 30000})
stennis:addSupportFlight("Hercules Flight", 3000, CarrierCommand.supportTypes.transport, {altitude = 500})
stennis:addSupportFlight("Falcon Flight", 3000, CarrierCommand.supportTypes.transport, {altitude = 500})
...
local personweight = 80
pl:registerSquadGroup(PlayerLogistics.infantryTypes.capture,  'capture-squad',  4*personweight, 200, 60,    60*60, 4, 2)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.sabotage, 'sabotage-squad', 4*personweight, 500, 60*5,  60*60, 4, 2)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.ambush,   'ambush-squad',   5*personweight, 300, 60*360, 60*60, 5, 2)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.engineer, 'engineer-squad', 2*personweight, 1000,60,    60*60, 2, 2)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.manpads,  'manpads-squad',  5*personweight, 500, 60*120, 60*60, 5, 2)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.spy,      'spy-squad',      personweight, 300, 60*5,  60*60, 1, 2)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.assault,  'assault-squad',  6*personweight, 600, 60*120,  60*60, 6, 2)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.rapier,   'rapier-squad',   1200,2000,60*120, 60*60, 8, 2)
